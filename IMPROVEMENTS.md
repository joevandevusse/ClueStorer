...
- [ ] **`Storer.java` — New DB connection opened per game**
...
- [ ] **`Storer.java` — Inconsistent and lossy error handling**
...
- [ ] **`Storer.java` — No validation of environment variables**
...
- [ ] **`Storer.java` — `DateTimeFormatter` should be `static final`**
  It is immutable and thread-safe; no need to create a new instance per `Storer` object.

- [ ] **`Storer.java` — Magic string table name**
